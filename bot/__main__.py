...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Channel", "https://t.me/UncensoredPlaygrounds")
...
'''
        ...
        sendMarkup('Fuck you bitch, join our telegram channel to use this bot.', context.bot, update.message, reply_markup)
